    ...
    <div className="main-container">
      ...
      <div className="access-card-list">
        <AcessCard
          ...
          buttonAction={""}
        />
        <AcessCard title="Vendas" text="Todas as métricas de marketing da sua empresa" icon={
          <Icon component={Work} style={{ fontSize: "36px", color: "#141774" }} className="access-card-icon" />
        } buttonAction={""} />
      </div>
    </div>
  );
